...
import { Shield, MessageSquare, ArrowLeft, ArrowRight } from 'lucide-react';
...
export default function TrustSection() {
  ...
  const links = [
    { label: t.links.trust1, url: telegramLinks.trustChannel, icon: Shield },
    { label: t.links.trust2, url: telegramLinks.reviewsChannel, icon: MessageSquare }
  ];
